...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { cpf: @funcionario.cpf, endereco: @funcionario.endereco, nome: @funcionario.nome, salario: @funcionario.salario, telefone: @funcionario.telefone }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { cpf: @funcionario.cpf, endereco: @funcionario.endereco, nome: @funcionario.nome, salario: @funcionario.salario, telefone: @funcionario.telefone }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
