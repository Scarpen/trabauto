...
class VendasControllerTest < ActionController::TestCase
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post :create, venda: { cliente_id: @venda.cliente_id, data: @venda.data, funcionario_id: @venda.funcionario_id, valor: @venda.valor }
    end
  ...
  test "should update venda" do
    patch :update, id: @venda, venda: { cliente_id: @venda.cliente_id, data: @venda.data, funcionario_id: @venda.funcionario_id, valor: @venda.valor }
    assert_redirected_to venda_path(assigns(:venda))
  end
